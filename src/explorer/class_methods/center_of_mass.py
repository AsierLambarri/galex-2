...
def refine_center(pos, 
    ...
    if method == "fractional-mass" or method == "fmc":
        centering_results = fractional_mass_center(pos, mass, mfrac)
    if method == "radial-cut" or method == "rcc":
        centering_results = radial_cut_center(pos, mass, rc_scale)
        
    if method == "shrink-sphere" or method == "ssc":
        centering_results = shrink_sphere_center(pos, mass, rsphere, alpha, nmin)  
...
def radial_cut_center(pos,
    ...
    centering_results = {'center': center_new ,
                         ...
                         'n_particles': len(pos[radii < rc_scale * rmax]),
                        }
